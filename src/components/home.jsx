...
const Home = ({ showAside, setShowAside }) => {
  ...
  if (showAside && windowWidth <= 640) {
    return null;
  }
  return (
    <div className={`${!showAside ? 'sm:relative md:absolute md:left-[180px] sm:left-0 top-[20px] w-auto h-auto' : 'sm:relative md:absolute md:left-[301px] sm:left-0 top-[20px] w-auto h-auto '} self-stretch`} >
      ...
      <div className="relative self-stretch left-[596px] top-[74px] flex flex-col justify-start items-start gap-7">
        <div className="h-36 p-5 bg-white rounded-lg shadow  flex-col justify-start items-start gap-5 inline-flex">
